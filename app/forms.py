...
class UserRegisterForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets={
            ...
            'password': forms.TextInput(attrs={'type':'password','id':"password",'name':"password",'ng-model':"formData.password",'ng-minlength':'8', 'ng-maxlength':'20','ng-pattern':'/(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z])/','required':'','class':'form-control ng-pristine ng-invalid ng-invalid-required ng-valid-maxlength ng-valid-minlength ng-valid-pattern',
